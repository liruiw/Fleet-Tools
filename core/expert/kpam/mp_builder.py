import numpy as np
import functools
from core.expert.kpam.transformations import affine_matrix_from_points
...
class OptimizationBuilderkPAM(object):
    ...
    @staticmethod
    def _process_axis_orthogonal_constraint_term(problem, keypoint_observation, constraint):
    ...
    def _process_keypoint_axisorthogonal_constraint_term(self, problem, keypoint_observation, constraint):
        ...
        # OK
        self._process_axis_orthogonal_constraint_term(problem, keypoint_observation, axis_constraint)


def test_builder():
    from core.kpam.optimization_spec import build_mug2rack, build_mug2shelf
